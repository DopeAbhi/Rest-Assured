...
public class oAuthTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.cssSelector("input[type='email']")).sendKeys("abhay.verma@w3villa.com");
        driver.findElement(By.cssSelector("input[type='email']")).sendKeys(Keys.ENTER);
        Thread.sleep(3000);
        driver.findElement(By.cssSelector("input[type='password']")).sendKeys("9838577522");
